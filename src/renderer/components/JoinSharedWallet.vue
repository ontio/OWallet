        ...
        <div class="boxOuter">
            <div class="box1">
                <div class="form-group">
                    <label>Shared Wallet Address</label>
                    <input type="text" class="form-control" v-model="sharedWalletAddress"
            ...
            <div class="box2" v-if="sharedWallet">
                <div class="form-group">
                    <label>Shared Wallet Name</label>
                    <input type="text" class="form-control" v-model="sharedWallet.sharedWalletName" disabled>
                </div>
                <div class="form-group">
                    <label>Total Number of Copayers</label>
                    <input type="text" class="form-control" v-model="sharedWallet.totalNumber" disabled>
                </div>
                <div class="form-group">
                    <label>Required Number of Copayers</label>
                    <input type="text" class="form-control" v-model="sharedWallet.requiredNumber" disabled>
                </div>
                <div class="form-group">
                    <label>Addresses of all Copayers</label>
                    <ul class="pkul">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary deploy-dialog-btn-close" data-dismiss="modal">
                            Cancel
                        </button>
...
<script>
  ...
  import { DEFAULT_SCRYPT, ONT_PASS_NODE, ONT_PASS_NODE_PRD, ONT_PASS_URL } from '../../core/consts'
