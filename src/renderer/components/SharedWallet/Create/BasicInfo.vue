    ...
    <div class="basic-container">
        ...
        <div class="basic-pks">
            <div class="pk-item" v-for="(item,index) in pks" :key="index">
                <a-input class="input" :class="item.nameValid?'':'error-input' "
                         :placeholder="$t('createSharedWallet.name')"
                         v-model="item.name"></a-input>
                <a-input class="input" :class="item.pkValid?'':'error-input' "
                         :placeholder="$t('createSharedWallet.publicKey')" v-model="item.publickey"
