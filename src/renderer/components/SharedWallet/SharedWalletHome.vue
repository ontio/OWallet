        ...
        <div class="content-container">
            <div class="left-half">
                ...
                <div class="owners-table">
                    <div class="table-item" v-for="(item,index) in sharedWallet.coPayers" :key="item.address"
                         v-if="index<2">
                        <span>{{item.name}}</span>
            ...
            <div class="right-half">
                <div class="pending-tx">
                    ...
                    <div class="pending-tx-container">
                        <div v-for="tx in pendingTx" :key="tx.transactionidhash" class="tx-item pendingTx-item"
...
<script>
  ...
  import { MAIN_NET, ONT_PASS_NODE, ONT_PASS_NODE_PRD, ONT_PASS_URL, TEST_NET } from '../../../core/consts'
