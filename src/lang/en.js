export default {
  ...
  nodeMgmt: {
    ...
    current: 'current',
    rewardsProportionTip1: '0% (nodes) indicates that the node will share all transaction fees and released ONG with users who have authorized stake.',
    rewardsProportionTip2: '0% (users) indicates that the node will share all transaction fees and released ONG with users who have authorized stake.',
    confirm: 'Confirm',
